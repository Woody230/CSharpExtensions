...
public class CompiledRegexJsonConverterTests
{
    ...
    public void Read()
    {
        ...
        {
            Regex = new("^(1|3|7)(2|4|9)$", RegexOptions.Compiled)
        };
